...
const int FrontBlue = 14;
const int BackBlue = 15;
...
void setup()
{
  ...
  pinMode (BackBlue, INPUT);
  pinMode (FrontBlue, INPUT); 
...
{ 
  ...
  if (digitalRead(BackBlue) == LOW && digitalRead(FrontBlue) == LOW)
  {
    panel_startup();
  }  
...
void panelCycle()
{
  ...
  if(digitalRead(BackBlue) == 0 && i1 == 0)
  {
    Serial.println("YES1");
  ...
  if(digitalRead(BackBlue) == 0 && i1 == 1)
  {
    Serial.println("YES2");
    analogWrite(RedPin1,255);
    analogWrite(GrnPin1,0);
  ...
  if(digitalRead(BackBlue) == 0 && i1 == 2)
  {
    Serial.println("YES3");
  ...
  if(digitalRead(BackBlue) == 0 && i1 == 3)
  {
    Serial.println("YES4");
    analogWrite(RedPin1,255);
  ...
  if(digitalRead(BackBlue) == 0 && i1 == 4)
  {
    Serial.println("YES5");
    analogWrite(RedPin1,200);
    analogWrite(GrnPin1,0);
  ...
  if(digitalRead(BackBlue) == 0 && i1 == 5)
  {
    Serial.println("YES6");
    analogWrite(RedPin1,0);
    analogWrite(GrnPin1,255);
  ...
  if(digitalRead(FrontBlue) == 0 && i2 == 0)
  {
    Serial.println("YES7");
  ...
  if(digitalRead(FrontBlue) == 0 && i2 == 1)
  {
    Serial.println("YES8");
    analogWrite(RedPin2,255);
    analogWrite(GrnPin2,0);
  ...
  if(digitalRead(FrontBlue) == 0 && i2 == 2)
  {
    Serial.println("YES9");
  ...
  if(digitalRead(FrontBlue) == 0 && i2 == 3)
  {
  ...
  if(digitalRead(FrontBlue) == 0 && i2 == 4)
  {
  ...
  if(digitalRead(FrontBlue) == 0 && i2 == 5)
  {
