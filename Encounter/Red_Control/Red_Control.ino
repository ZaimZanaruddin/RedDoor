...
const int FrontRed = 14;
const int BackRed = 15;
...
void setup()
{
  ...
  pinMode (BackRed, INPUT);
  pinMode (FrontRed, INPUT);
...
void loop()
{
 ...
 if (digitalRead(BackRed) == LOW && digitalRead(FrontRed) == LOW)
  {
    panel_startup();
  }  
...
void panelCycle()
{
  ...
  if(digitalRead(FrontRed) == 0 && i2 == 0)
  {
  ...
  if(digitalRead(FrontRed) == 0 && i2 == 1)
  {
    analogWrite(RedPin2,255);
    analogWrite(GrnPin2,0);
    analogWrite(BluPin2,0);
  ...
  if(digitalRead(FrontRed) == 0 && i2 == 2)
  {
  ...
  if(digitalRead(FrontRed) == 0 && i2 == 3)
  {
    analogWrite(RedPin2,255);
  ...
  if(digitalRead(FrontRed) == 0 && i2 == 4)
  {
    analogWrite(RedPin2,200);
    analogWrite(GrnPin2,0);
    analogWrite(BluPin2,200);
  ...
  if(digitalRead(FrontRed) == 0 && i2 == 5)
  {
    analogWrite(RedPin2,0);
    analogWrite(GrnPin2,255);
    analogWrite(BluPin2,0);
